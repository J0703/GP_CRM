...
<form action="findDepartment.action" method="post">
    <table width="100%" border="1" >
        ...
        <s:iterator value="#pageBean.date" var="depart">
            <tr class="tabtd1">
                <td align="center">${depart.depName}</td>
                <td width="7%" align="center">
                    <a href="${pageContext.request.contextPath}/beforeUpdateDepName.action?depID=${depart.depID}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
                </td>
            </tr>
        </s:iterator>
    </table>
<input id="pageNum" name="pageNum" type="hidden" align="center"/>
</form>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right">
    	<span>第<s:property value="#pageBean.pageNum"/>/<s:property value="#page.Bean.totalPage"/>页</span>
        <span>
