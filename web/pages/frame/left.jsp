...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010301','0103','班级管理','${pageContext.request.contextPath}/findClasses.action','','right');
		d.add('010302','0103','课程类别','${pageContext.request.contextPath}/findCourseType.action','','right');
		d.add('0104','01','就业部');
